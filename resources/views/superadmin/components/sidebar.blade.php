<div class="d-flex flex-row">
    <!-- Sidebar -->
    <div class="navigation d-flex flex-column align-items-start flex-shrink-0 bg-light" style="position: fixed; z-index: 10000;">
        <ul id="menu" class="list-unstyled w-100">
            <li>
                <a href="#">
            ...
            <li class="nav-item dropdown">
                <a href="#" id="settingsDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <span class="icon">
